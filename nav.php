  ...
  <div class="right-container">
    <ul style="float:right;">
        ...
        <li>
          ...
          <ul>
            <li><a href="filter_products.php?file=<?php echo $currentFile; ?>&filter=default"><i class="fa-solid fa-bars" style="padding-right:5px;"></i>Default</a></li>
            <li><a href="filter_products.php?file=<?php echo $currentFile; ?>&filter=lowToHigh"><i class="fa-solid fa-arrow-down-short-wide" style="padding-right:5px;"></i>Low to High</a></li>
            <li><a href="filter_products.php?file=<?php echo $currentFile; ?>&filter=highToLow"><i class="fa-solid fa-arrow-down-wide-short" style="padding-right:5px;"></i>High to Low</a></li>
          </ul>
        </li>
        <li>
